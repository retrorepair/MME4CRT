...
default_sublabel_macro(action_bind_sublabel_crt_debug_mode,       MENU_ENUM_SUBLABEL_CRT_DEBUG_MODE)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_CRT_SWITCH_X_AXIS_CENTERING:
            ...
            break;
         case MENU_ENUM_LABEL_CRT_DEBUG_MODE:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_crt_debug_mode);
            break;
